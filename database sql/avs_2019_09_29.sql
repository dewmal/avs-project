...
--
-- Host: localhost
-- Generation Time: Sep 29, 2019 at 12:43 PM
...
CREATE TABLE `customer` (
  ...
  `serviceSupplier` varchar(20) DEFAULT NULL,
...
ALTER TABLE `customer` ADD `status` INT NOT NULL DEFAULT '0' AFTER `gpsLocation`;
-- --------------------------------------------------------
